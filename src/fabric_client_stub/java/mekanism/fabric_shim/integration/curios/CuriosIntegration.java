 ...
 * empty result, so charge/mode code compiles and simply finds nothing worn — the guarding
 * {@code Mekanism.hooks.curios.isLoaded()} is false on the port, so these paths never run anyway.
 */
