...
| 4-baked | MekBakedModelExt inject-interface (getQuads+ModelData/getRenderPasses/getRenderTypes/applyTransform) + mixin; BakedModelWrapper/IDynamicBakedModel/ChunkRenderTypeSet shims; MekanismISTER/RenderEnergyCubeItem residues | pending |
...
| 4-obj | OBJ stubs (ObjModel/ObjLoader/ModelSettings → missing geometry) + quad utils (IQuadTransformer/QuadBakingVertexConsumer) | pending |
