...
| 4-quadbaker | QuadBakingVertexConsumer faithful impl (VertexConsumer → BakedQuad; Quad.bake used by machine-overlay QuadTransformation, milestone-adjacent) | pending |
