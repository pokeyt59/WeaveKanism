...
| 3b | Client game-bus events (cluster 2) + mixins: ShimClientGameplayEvents over ClientTickEvents/ClientPlayConnectionEvents/WorldRenderEvents/ScreenEvents + mixins (MouseHandler, RecipesUpdated tail, LivingEntityRenderer, fog, ItemInHandRenderer, SoundEngine play/load, atlas tail) | pending (~400 in root/render/sound) |
